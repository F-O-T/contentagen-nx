...
import { type AgentChatRequest, useAgentChat } from "./use-agent-chat";
...
export function useChatSession(
   ...
   const sendMessage = useCallback(
      async (
         ...
         const effectivePlanContext =
            planContext ||
            (currentMode === "writer" ? currentActivePlan : undefined);
