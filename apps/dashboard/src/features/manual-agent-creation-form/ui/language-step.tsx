...
import { LanguageConfigSchema } from "@packages/database/schemas/agent-types";
            ...
            <field.FieldContainer className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => {
                  if (value === "none") {
                    ...
                    field.handleChange(value as typeof variantOptions[number]);
                  }
                }}
                onOpenChange={(open) => {
                  if (!open) {
              ...
              >
                <SelectTrigger className="w-full">
                  <SelectValue placeholder={primaryLanguage ? "Select variant..." : "Select primary language first"} />
                </SelectTrigger>
                <SelectContent>
