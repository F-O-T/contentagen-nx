...
import { BarChart3, Clock, FilePlus, FileText } from "lucide-react";
...
function AnalyticsStat({
   ...
   return (
      <div className="flex items-center gap-3">
         <div
            className={`flex items-center justify-center size-10 rounded-lg ${variantClasses[variant]}`}
         >
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
               ...
               <div className="flex items-center gap-3 sm:col-span-2 lg:col-span-1">
                  ...
                  <div>
                     ...
                     <Badge
                        variant={contentCount > 0 ? "default" : "secondary"}
                     >
                        {contentCount > 0 ? "Ativo" : "Inativo"}
                     </Badge>
                  </div>
               </div>
            </div>
