        ...
        {showNewKeyBox && (
          <div className="bg-muted rounded-md p-3 flex flex-col gap-2 border border-primary/20">
            <div className="flex items-center gap-2">
              <span className="font-mono text-xs break-all">{newKey.key}</span>
              <Button
                variant="ghost"
                size="icon"
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 font-mono text-xs bg-gray-50 dark:bg-gray-900 rounded px-2 py-1">
                    <span>
                      {isShowing ? k.key : `${k.prefix}_...${k.start}`}
                    </span>
                    <Button
                      variant="ghost"
                      size="icon"
                  ...
                  <div className="flex flex-wrap gap-2 text-xs mt-1">
                    <span
                      className={k.enabled ? "text-green-600" : "text-red-600"}
                    >
                    ...
                    <span>
                      Usage: {k.remaining != null ? `${k.remaining} left` : "∞"}
                      {k.requestCount != null
                        ? ` (${k.requestCount} used)`
                        : ""}
                    </span>
