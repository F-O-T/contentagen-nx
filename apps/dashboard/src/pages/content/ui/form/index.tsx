   ...
   const validateCurrentStep = async () => {
      switch (currentStep) {
         case ContentFormStep.TemplateSelection:
            try {
               TemplateSelectionFormSchema.parse(
         ...
         case ContentFormStep.WriteInstructions:
            try {
               WriteInstructionsFormSchema.parse(
         ...
         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <form className="space-y-4" onSubmit={handleFinalSubmit}>
               {currentStep === ContentFormStep.TemplateSelection && (
                  <TemplateSelection
                     form={
                        templateSelectionForm as FormApi<TemplateSelectionFormData>
                     }
                  />
               )}
               ...
               {currentStep === ContentFormStep.ConfigureAgent && (
                  <ConfigureAgent
                     form={
                        configureAgentForm as FormApi<ConfigureAgentFormData>
                     }
                  />
               )}
               ...
               {currentStep === ContentFormStep.WriteInstructions && (
                  <WriteInstructions
                     form={
                        writeInstructionsForm as FormApi<WriteInstructionsFormData>
                     }
                  />
               )}
               ...
               {currentStep === ContentFormStep.ArticleExample && (
                  <ArticleExample
                     form={
                        articleExampleForm as FormApi<ArticleExampleFormData>
                     }
                  />
               )}
