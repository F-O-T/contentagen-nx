                           ...
                           {methods.switch({
                              ...
                              "step-voice-tone": () => (
                                 <form.Subscribe
                                    selector={(state) => ({
                                       ...
                                       voiceToneErrors:
                                          state.fieldMeta?.voiceTone?.errors,
                                    })}
                                 >
                              ...
                              "step-target-audience": () => (
                                 <form.Subscribe
                                    selector={(state) => ({
                                       targetAudience:
                                          state.values.targetAudience,
                                       targetAudienceErrors:
                                          state.fieldMeta?.targetAudience
                                             ?.errors,
                                    })}
                                 >
                                    {({
                              ...
                              "step-formatting-style": () => (
                                 <form.Subscribe
                                    selector={(state) => ({
                                       formattingStyle:
                                          state.values.formattingStyle,
                                       formattingStyleErrors:
                                          state.fieldMeta?.formattingStyle
                                             ?.errors,
                                    })}
                                 >
                                    {({
                              ...
                              "step-topics-seo": () => (
                                 ...
                                 >
                                    {({
                                       ...
                                       const canGoNext =
                                          isTopicsValid && isSeoKeywordsValid;
                                       return (
                                          <Button
                                             className="gap-4"
                                             onClick={methods.next}
