    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>All the details about your competitor</CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
                <InfoItem icon={<User className="h-4 w-4" />} label="Name" value={name} />
                <InfoItem icon={<Globe className="h-4 w-4" />} label="Website" value={websiteUrl} />
