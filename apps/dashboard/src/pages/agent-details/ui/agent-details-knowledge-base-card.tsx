...
export function AgentDetailsKnowledgeBaseCard({
   ...
   async function handleWebsiteSubmit() {
      ...
      try {
         // TODO: Replace with actual TRPC endpoint for brand website extraction
         // This functionality needs to be implemented in the TRPC router
         console.log("Would extract brand knowledge from:", websiteUrl, "for agent:", agentId);
         setSubmitMessage("Brand website extraction feature is temporarily unavailable. Please upload files directly.");
         setWebsiteUrl("");
      } catch (err) {
