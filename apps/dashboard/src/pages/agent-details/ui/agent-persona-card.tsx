// apps/dashboard/src/pages/agent-details/ui/agent-persona-card.tsx
...
export const AgentPersonaCard: React.FC<AgentPersonaCardProps> = ({
  ...
  const items = useMemo(
    () => [
      { label: "Content Type", value: formatValue(contentType), icon: FileText },
      { label: "Voice Tone", value: formatValue(voiceTone), icon: Megaphone },
      { label: "Target Audience", value: formatValue(targetAudience), icon: Users },
      { label: "Formatting Style", value: formatValue(formattingStyle), icon: Type },
    ],
