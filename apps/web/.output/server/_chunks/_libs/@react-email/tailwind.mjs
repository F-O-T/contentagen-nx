...
import { B as Body } from "./body.mjs";
import { B as Button } from "./button.mjs";
import { C as CodeBlock } from "./code-block.mjs";
import { C as CodeInline } from "./code-inline.mjs";
import { C as Container } from "./container.mjs";
import { H as Heading } from "./heading.mjs";
import { H as Hr } from "./hr.mjs";
import { I as Img } from "./img.mjs";
import { L as Link } from "./link.mjs";
import { P as Preview } from "./preview.mjs";
import { T as Text } from "./text.mjs";
import { r as rf } from "../../../_libs/tailwindcss.mjs";
...
var require_base64 = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/source-map-js@1.2.1/node_modules/source-map-js/lib/base64.js": ((exports$1) => {
  ...
  exports$1.encode = function(number$1) {
...
var require_source_map_generator = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/source-map-js@1.2.1/node_modules/source-map-js/lib/source-map-generator.js": ((exports$1) => {
  ...
  exports$1.SourceMapGenerator = SourceMapGenerator$1;
}) });
var import_source_map_generator = /* @__PURE__ */ __toESM(require_source_map_generator());
    ...
    enter(node$1) {
      if (node$1.type === "Declaration") {
        ...
        if (/--[\S]+/.test(declaration.property)) variableDefinitions.add({
          ...
          let parseVariableUsesFrom = function(node$2) {
            walk(node$2, {
              visit: "Function",
              enter(funcNode) {
...
function lrgbToRgb(input) {
  ...
  if (absoluteNumber > 31308e-7) return sign * (absoluteNumber ** (1 / 2.4) * 1.055 - 0.055);
  return input * 12.92;
}
...
function mapReactTree(value, process) {
  const mapped = React__default.Children.map(value, (node) => {
    if (React__default.isValidElement(node)) {
      ...
      const processed = process(React__default.cloneElement(node, newProps, newProps.children));
      if (React__default.isValidElement(processed) && isComponent(processed)) return mapReactTree((typeof processed.type === "object" ? processed.type.render : processed.type)(processed.props), process);
      return processed;
    }
    return process(node);
  });
...
function cloneElementWithInlinedStyles(element, inlinableRules, nonInlinableRules, customProperties) {
  ...
  return React__default.cloneElement(element, newProps, newProps.children);
}
const css$3 = `
...
@config;
`;
  const compiler = await rf(baseCss, {
  ...
  mappedChildren = mapReactTree(mappedChildren, (node) => {
    if (reactExports.isValidElement(node)) {
      ...
      if (elementWithInlinedStyles.type === "head") {
        ...
        const styleElement = /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: generate(nonInlineStyles) });
        return reactExports.cloneElement(elementWithInlinedStyles, elementWithInlinedStyles.props, styleElement, elementWithInlinedStyles.props.children);
      }
