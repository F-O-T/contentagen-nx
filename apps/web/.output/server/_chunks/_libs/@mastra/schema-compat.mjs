import { j as jsonSchemaToZod$1, i as its, p as parseSchema, a as addJsdocs, b as parseAnyOf, c as parseOneOf, d as parseAllOf } from "../../../_libs/json-schema-to-zod.mjs";
import { B as z, a as string, g as any, F as ZodOptional, G as ZodObject, H as ZodNull, I as ZodArray, J as ZodUnion, K as ZodString, L as ZodNumber, M as ZodDate, N as ZodDefault, o as object$1, O as ZodNever, h as array, i as union, n as number, P as ZodNullable, Q as strictObject, R as ZodUnknown, z as looseObject, j as _instanceof, f as custom, k as lazy, m as _null, c as boolean, r as record, l as literal, u as unknown, e as optional, q as ZodFirstPartyTypeKind } from "../../../_libs/zod.mjs";
import { c as convertJsonSchemaToZod } from "../../../_libs/zod-from-json-schema.mjs";
import { c as convertJsonSchemaToZod$1 } from "../../../_libs/zod-from-json-schema-v3.mjs";
  ...
  if (objectSchema.properties) {
    if (!Object.keys(objectSchema.properties).length) {
      ...
      properties += Object.keys(objectSchema.properties).map((key) => {
        ...
        const optional2 = !hasDefault && !required;
        return optional2 ? `${result}.optional()` : result;
      }).join(", ");
      properties += " })";
    }
  }
...
function zodToJsonSchema(zodSchema2, target = "jsonSchema7", strategy = "relative") {
  const fn = "toJSONSchema";
  {
    patchRecordSchemas(zodSchema2);
    return z[fn](zodSchema2, {
      unrepresentable: "any",
      override: (ctx) => {
...
export {
  AnthropicSchemaCompatLayer as A,
  DeepSeekSchemaCompatLayer as D,
  GoogleSchemaCompatLayer as G,
  MetaSchemaCompatLayer as M,
  OpenAIReasoningSchemaCompatLayer as O,
  OpenAISchemaCompatLayer as a,
  applyCompatLayer as b,
  convertZodSchemaToAISDKSchema as c,
  jsonSchema as d,
