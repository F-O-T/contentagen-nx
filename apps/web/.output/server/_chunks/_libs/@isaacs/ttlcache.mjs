...
function requireTtlcache() {
  ...
  class TTLCache2 {
    ...
    clear() {
      const entries = this.dispose !== TTLCache2.prototype.dispose ? [...this] : [];
      this.data.clear();
...
var ttlcacheExports = /* @__PURE__ */ requireTtlcache();
const TTLCache = /* @__PURE__ */ getDefaultExportFromCjs(ttlcacheExports);
export {
  TTLCache as T
};
