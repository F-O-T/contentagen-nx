...
import https___default from "https";
import zlib from "zlib";
import { a as getAugmentedNamespace } from "../_chunks/_libs/@ioredis/commands.mjs";
...
function fetch(url, opts) {
  ...
  return new fetch.Promise(function(resolve, reject) {
    ...
    const send = (options.protocol === "https:" ? https___default : http__default).request;
