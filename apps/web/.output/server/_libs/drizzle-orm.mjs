...
function drizzle(...params) {
  if (typeof params[0] === "string") {
    const instance = new pg__default.Pool({
  ...
  if (isConfig(params[0])) {
    ...
    const instance = typeof connection === "string" ? new pg__default.Pool({
      connectionString: connection
    }) : new pg__default.Pool(connection);
...
export {
  ...
  relations as H,
  SQL as S,
  getViewSelectedFields as a,
  is as b,
  isView as c,
  drizzle as d,
  count as e,
  desc as f,
  getTableColumns as g,
  asc as h,
  isTable as i,
  inArray as j,
  lt as k,
