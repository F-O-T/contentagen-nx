import { g as getTableColumns, a as getViewSelectedFields, i as isTable, b as is, C as Column, S as SQL, c as isView } from "./drizzle-orm.mjs";
import { g as any, o as object, B as z, i as union, f as custom, r as record, h as array, a as string, n as number, c as boolean, m as _null } from "./zod.mjs";
const CONSTANTS = {
  INT8_MIN: -128,
  INT8_MAX: 127,
...
const literalSchema = union([string(), number(), boolean(), _null()]);
...
function numberColumnToSchema(column, z2, coerce) {
  ...
  let schema = coerce === true || coerce?.number ? integer ? z2.coerce.number() : z2.coerce.number().int() : integer ? z2.int() : z2.number();
...
export {
  createSelectSchema as a,
  createInsertSchema as c
};
