...
import { x as defineHandlerCallback, y as getNormalizedURL, z as getOrigin, A as createSerializationAdapter, C as attachRouterServerSsrUtils, D as createRawStreamRPCPlugin, i as isNotFound, f as isRedirect, E as isResolvedRedirect, F as mergeHeaders, G as executeRewriteInput, H as defaultSerovalPlugins, I as makeSerovalPlugin, b as rootRouteId, k as transformPipeableStreamWithRouter, j as transformReadableStreamWithRouter } from "../_chunks/_libs/@tanstack/router-core.mjs";
...
import { S as So, L as Lo, g as go } from "../_libs/seroval.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-9bOp0_nK.mjs");
        ...
        if (FORM_DATA_CONTENT_TYPES.some(
          ...
          if (typeof serializedContext === "string") {
            try {
              ...
              const deserializedContext = Lo(parsedContext, {
...
async function loadEntries() {
  const routerEntry = await import("./router-HyRWfAJI.mjs").then((n) => n.ad);
...
const serverCQvioJOX = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  HEADERS,
  StartServer,
  attachRouterServerSsrUtils,
