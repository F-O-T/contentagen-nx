    ...
    <div className="flex min-h-screen w-full overflow-hidden bg-background">
      ...
      <aside className="hidden lg:flex lg:w-[40%] relative flex-col justify-between bg-gradient-to-br from-primary via-primary/95 to-primary/85 p-8 xl:p-12 order-2">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <img
              ...
              src="/favicon.svg"
            />
            <span className="text-xl font-semibold text-white">Contentta</span>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-white/70 text-sm xl:text-base max-w-sm mx-auto">
              Crie conteudos incriveis com inteligencia artificial. Blog posts,
              artigos e muito mais em minutos.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 text-white/50 text-xs">
          &copy; {new Date().getFullYear()} Contentta. Todos os direitos reservados
        </div>
      </aside>
    </div>
  )
