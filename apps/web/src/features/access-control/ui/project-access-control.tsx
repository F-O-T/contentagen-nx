...
import { EllipsisVertical, Search, ShieldCheck, UserPlus } from "lucide-react";
		...
		orpc.team.addMember.mutationOptions({
			onSuccess: () => {
				queryClient.invalidateQueries({
					queryKey: orpc.team.getMembers.queryOptions({ input: { teamId } })
						.queryKey,
				});
	...
	return (
		<div className="space-y-6">
			...
			<section className="space-y-3">
				<div className="flex items-center justify-between">
					<div>
						<h2 className="text-lg font-medium">Membros da organização</h2>
						<p className="text-sm text-muted-foreground mt-1">
							Controle quais membros da organização podem acessar este projeto
						</p>
					</div>
				</div>
