			...
			<CardContent>
				<div className="space-y-3">
					<p className="text-sm text-muted-foreground">
						Compartilhe suas necessidades e vamos priorizar as integrações que
						mais importam para você:
					</p>
					<ul className="space-y-1.5 text-sm text-muted-foreground list-disc list-inside">
						<li>Quais plataformas você usa hoje para publicar conteúdo?</li>
						<li>Que ferramentas de analytics ou SEO você gostaria de integrar?</li>
						<li>Há alguma integração específica que desbloquearia seu workflow?</li>
					</ul>
					<Button
						className="mt-2"
