 ...
 * ```
 */
export function createContenttaAdapter(contentId?: string): ChatModelAdapter {
   return {
            ...
            switch (chunk.type) {
               ...
               case "tool_call_start": {
                  ...
                  contentParts.push({
                     ...
                     toolCallId: id,
                     toolName: name,
                     // biome-ignore lint/suspicious/noExplicitAny: ORPC args are compatible with ReadonlyJSONObject
                     args: args as any,
                  });
