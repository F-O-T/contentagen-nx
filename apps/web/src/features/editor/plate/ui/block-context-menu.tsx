	...
	return (
		<ContextMenu>
			...
			<ContextMenuContent>
				...
				<ContextMenuSeparator />
				<ContextMenuItem onClick={() => handleAIAction("Melhore este bloco de conteúdo")}>
					<WandSparkles className="mr-2 size-4" />
					Melhorar com IA
				</ContextMenuItem>
				<ContextMenuItem onClick={() => handleAIAction("Expanda este bloco de conteúdo com mais detalhes")}>
					<Sparkles className="mr-2 size-4" />
					Expandir com IA
				</ContextMenuItem>
				<ContextMenuItem onClick={() => handleAIAction("Resuma este bloco de conteúdo de forma concisa")}>
					<Sparkles className="mr-2 size-4" />
					Resumir com IA
				</ContextMenuItem>
			</ContextMenuContent>
