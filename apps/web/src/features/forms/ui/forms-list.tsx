				...
				<CardContent className="py-12">
					<Empty>
						<EmptyContent>
							...
							<EmptyDescription>
								Crie seu primeiro formulário para começar a coletar dados dos
						...
						<DropdownMenu>
							...
							<DropdownMenuContent align="end">
								<DropdownMenuItem asChild>
									<Link
										to="/$slug/forms/$formId"
										params={{ slug: slug || "", formId: form.id }}
									>
								...
								<DropdownMenuItem asChild>
									<Link
										to="/$slug/forms/$formId/submissions"
										params={{ slug: slug || "", formId: form.id }}
									>
					...
					<CardContent className="flex-1 pt-0">
						<div className="flex items-center gap-3 text-sm text-muted-foreground">
							...
							<span>
								...
								{form.submissionCount === 1 ? "submissão" : "submissões"}
							</span>
						</div>
						<div className="mt-3">
