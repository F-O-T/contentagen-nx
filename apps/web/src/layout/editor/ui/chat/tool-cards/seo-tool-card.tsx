						...
						{analysis.score !== undefined && (
							<div>
								<div className="flex items-center justify-between mb-1">
									<span className="text-muted-foreground">Pontuação SEO</span>
									<span className="font-bold text-sm">{analysis.score}/100</span>
								</div>
						...
						{analysis.recommendations && analysis.recommendations.length > 0 && (
							<div>
								...
								{analysis.recommendations.length > 3 && (
									<div className="text-muted-foreground mt-1">
										+{analysis.recommendations.length - 3} mais recomendações
									</div>
								)}
							</div>
						)}
								...
								<div>
									...
									<div className="space-y-1">
										{Object.entries(analysis.keywordDensity)
											.slice(0, 5)
											.map(([keyword, density]) => (
												<div className="flex items-center justify-between" key={keyword}>
