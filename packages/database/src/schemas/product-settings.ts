...
export const productSettings = pgTable(
	"product_settings",
	{
		...
		contentDefaults: jsonb("content_defaults").$type<ContentDefaults>().default({}),
...
export const ProductSettingsInsertSchema =
	createInsertSchema(productSettings);
export const ProductSettingsSelectSchema =
	createSelectSchema(productSettings);
