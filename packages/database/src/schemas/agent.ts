...
/* ------------------------------------------------------------------
   2.  Voice & Tone
------------------------------------------------------------------ */
const VoiceConfigSchema = T.Object({
   toneMix: T.Array(
      Weighted(
         T.Union([
...
/* ------------------------------------------------------------------
   3.  Audience
------------------------------------------------------------------ */
const AudienceConfigSchema = T.Object({
   base: T.Union([
   ...
   regions: T.Optional(T.Array(T.String())), // ISO-3166 or free text
...
/* ------------------------------------------------------------------
   4.  Format & Structure
------------------------------------------------------------------ */
const FormatConfigSchema = T.Object({
   style: T.Union([
...
/* ------------------------------------------------------------------
   5.  Language
------------------------------------------------------------------ */
const LanguageConfigSchema = T.Object({
...
const BrandConfigSchema = T.Object({
...
------------------------------------------------------------------ */
const RepurposeChannelSchema = T.Union([
   T.Literal("blog_post"),
